...
KMHV3_FIR = ../kunminghu-v3/build/rtl/XSTop.fir # git checkout 93e4c986cb705ce6b741ef4b98eb50923c25d369 && make verilog
...
scala-new.csv: cal-scala.py
	./cal-scala.py > scala-new.csv
